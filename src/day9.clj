...
(comment
  (part-1 (parse-input "109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99") [])
  (part-1 (parse-input "1102,34915192,34915192,7,4,7,99,0") [])
  (part-1 (parse-input "104,1125899906842624,99") [])
  (part-1 (parse-input input) [1])                          ;2775723069
  )
...
(comment
  (part-2 (parse-input input) [2])                          ;49115
  )
